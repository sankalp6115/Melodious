...
window.onekoStart = function () {
  if (window.__onekoRunning) return; // prevent multiple instances
  ...
  function init() {
    ...
    let nekoFile = "../Assets/Images/Animations/oneko.gif";
...
window.onekoStop = function () {
  ...
  // Sadly, we can't cancel animationFrame easily unless we store it globally,
  // but we at least remove mousemove listener if we store that.
